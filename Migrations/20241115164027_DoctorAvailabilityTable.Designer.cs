...
namespace assestment_JuaJoseZapata.Migrations
{
    ...
    [Migration("20241115164027_DoctorAvailabilityTable")]
    partial class DoctorAvailabilityTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("assestment_JuaJoseZapata.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 11, 15, 11, 40, 26, 856, DateTimeKind.Local).AddTicks(4343),
                            Name = "doctor"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2024, 11, 15, 11, 40, 26, 856, DateTimeKind.Local).AddTicks(4382),
                            Name = "patient"
                        });
                });
            ...
            modelBuilder.Entity("assestment_JuaJoseZapata.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 11, 15, 11, 40, 26, 974, DateTimeKind.Local).AddTicks(5300),
                            Email = "zapata.devs@gmail.com",
                            Name = "Juan Jose",
                            Password = "$2a$11$6MHZd24BxUsdjgZsAA0wW.rsTYwxXba9BZDPaz.aPHnZE39nZFbbq",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2024, 11, 15, 11, 40, 27, 94, DateTimeKind.Local).AddTicks(9698),
                            Email = "user@example.com",
                            Name = "Test",
                            Password = "$2a$11$NE1G.k/TqNw9UouZnd2suOOiNsPyagBq5wSPs/tl9yLV5SBFc4Yz6",
                            RoleId = 2
                        });
                });
